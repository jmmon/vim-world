...
export default component$<ChooseUsernameProps>(({ state }) => {
    ...
    const onSubmit = $(async () => {
        try {
            ...
            const { player, isNew } = await httpService.api.player(formData);
            console.log("/api/player response:", { player, isNew });

            handlers.initClientData(state, {
                player: player,
        ...
        <>
            ...
            >
                <div class="content flex flex-col gap-2">
                    ...
                    <p>
                        This is unique for the character. Same name gets same
                        character!
                    </p>
                    <form
                        onSubmit$={onSubmit}
