...
//         const row: Tile[] = [];
//         for (let x = 0; x < CHUNK_SIZE; x++) {
//             row.push(generateBaseTile(rng, ruleset));
//         }
//         mapTiles.push(row);
//     }
//     return mapTiles;

// function generateBaseMap(seed: number, config: MapConfig2): Tile[][] {
//     const rng = mulberry32(seed);
//     const map: Tile[][] = [];
//
...
//             let tile: Tile;
//             if (r < 0.1) {
//                 tile = { type: "water", collision: COLLISION };
//             } else if (r < 0.2) {
//                 tile = { type: "tree", collision: COLLISION };
//             } else {
//                 tile = { type: "floor", collision: { solid: false } };
//             }
//
//             row.push(tile);
//         }
